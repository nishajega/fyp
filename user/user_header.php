    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../course2.php" style="color:black;">Course</a></li>
			...
			<?php if(!isset($_SESSION['user_id'])): ?>
                        <li class='nav-item'><a class='nav-link js-scroll-trigger' href='login.php' style='color:black;'>Register/Login</a></li>
                    <?php else: ?>
