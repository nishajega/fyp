...
if (isset($_POST['submit'])) {
    ...
    $instructor_name = get_safe_value($con, $_POST['instructor_name']);
        ...
        if (isset($_GET['id']) && $_GET['id'] != '') {
			...
			dates3='$dates3', dates4='$dates4',status='Reject' where id='$id'");
	?>
        <script type="text/javascript">
        ...
        <?php
            ...
            mysqli_query($con, "insert into courses(categories_id,name,description,overview,audience_target,duration,price,dates,instructor_name,status) 
			values('$categories_id','$name','$description','$overview','$audience_target','$duration','$price','$dates','$instructor_name','Pending')");
        }
    ?>
...
<div class="container-fluid">
    ...
    <form method="post" action="">
        ...
        <div class="instr">
            ...
            <input type="date" placeholder="dd/mm/yyyy" name="dates" id="dates" value="<?php echo $dates ?>"><br>
