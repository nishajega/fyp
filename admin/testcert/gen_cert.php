   ...
   //Returns IST
      ...
      $stmt = "SELECT * from cert WHERE idcert=$id";
      ...
      if ($name == "" || $occupation == "") {
        ...
        $text3 = imagettftext($createimage, $font_size_occupation, $rotation, $origin2_x, $origin2_y, $black, $drFont1, $row[4]);

        $text3 = imagettftext($createimage, $font_size_occupation, $rotation, $origin3_x, $origin3_y, $black, $drFont1, $row[3]);
