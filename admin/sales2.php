...
<p style= "margin-left:540px;">Month:<strong>'.$months.'</strong></p>
</div>
   ...
   <table>
      ...
      <tbody>';
		...
		$best_seller_qty=mysqli_query($con, $bestqty);
		 ...
		 endwhile;
		 $html.= '<tr>
                 <td colspan="3" style="font-weight: bold;">Best Seller of the Month (by Quantity)</td>
                 </tr>';
      $html.='</tbody>
   </table>
</div><br><br>
   ...
   <table>
      ...
      <tbody>';
		...
		$best_seller=mysqli_query($con, $best);
		 ...
		 endwhile;
		 $html.= '<tr>
                 <td colspan="3" style="font-weight: bold;">Best Seller of the Month (by Price)</td>
                 </tr>';
      $html.='</tbody>
   </table>
</div><br><br><br><br>
   ...
   <table>
      ...
      <tbody>';
		$least="select DISTINCT(order_detail.product_id),sum(order_detail.quantity) as total, sum(order_detail.price) as 
		 ...
		 endwhile;
		 $html.= '<tr>
                 <td colspan="3" style="font-weight: bold;">Least Sold (by Price)</td>
                 </tr>';
      $html.='</tbody>
   </table>
</div><br><br>
   ...
   <table>
      ...
      <tbody>';
		...
		$least_seller_qty=mysqli_query($con, $leastqty);
         ...
         $html.='<tr>
            <td class="product-name">'.$least_row_qty['name'].'</td>
            <td class="product-name">'.$least_row_qty['total'].'</td>
            <td class="product-name">'. $least_row_qty['totalprice'].'</td>
         </tr>';
		 endwhile;
		 $html.= '<tr>
                 <td colspan="3" style="font-weight: bold;">Least Sold (by Quantity)</td>
                 </tr>';
      $html.='</tbody>
   </table>
</div>';
