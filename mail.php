          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="http://localhost/eepms/" class="f-fallback email-masthead_name">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Thanks for registering with UNITEN Executive Education Programme website. This is an invoice for your recent purchase.
												Your order status is <strong>Success</strong>. You can also check in the website for <strong>My Order</strong> for more information regarding your order.</p>
